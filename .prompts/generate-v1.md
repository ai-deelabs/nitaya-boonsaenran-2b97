...
full-bleed split-screen hero, oversized condensed serif stacked flush-left, cold negative space right — thin high-contrast didone serif (like Didot), tracked-out small caps for labels — dark mode: obsidian black #0A0A0C canvas + single frost-cyan electric accent #7FDBFF, referencing the monolith/cryo-chamber lighting of "2001: A Space Odyssey" — clinical, hushed, futuristic cold
